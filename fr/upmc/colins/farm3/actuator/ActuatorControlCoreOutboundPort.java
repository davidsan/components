 ...
 */
public class ActuatorControlCoreOutboundPort 
...
implements ControlRequestArrivalI
{
	...
	public ActuatorControlCoreOutboundPort(
			String uri,
			ComponentI owner
			) throws Exception 
	{
	...
	//	System.out.println("hello");
		boolean rep = ((ControlRequestArrivalI)this.connector).updateClockSpeed(cs);
